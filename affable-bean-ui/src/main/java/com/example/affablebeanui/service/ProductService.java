...
public class ProductService {
    ...
    public ResponseEntity transfer(String to_email,
        ...
        return template.postForEntity("http://localhost:8090/account/transfer",data,String.class);
    }

    public ResponseEntity saveCartItem(){
        return template.getForEntity("http://localhost:9000/transport/cart/save",
                String.class);
    }
    ...
    public ProductService(final CartService cartService){
       ...
       var productsResponseEntity = template.getForEntity(
               "http://localhost:8095/backend/products",
               Products.class);
